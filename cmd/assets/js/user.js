; let vm = new Vue({
    ...
    methods: {
        ...
        save() {
            ...
            axios.post('/users/update/' + this.user.id, {
                name: this.user.name,
                email: this.user.email,
        ...
        reset(index, row) {
            this.$confirm('确定重置密码?', '提示', {
                ...
                axios.get('/password/reset/' + row.id).then(function (response) {
                    vm.loading.app = false;
                    let resp = response.data;
        ...
        del(index, row) {
            this.$confirm('确定删除？', '提示', {
                ...
                axios.get('/users/delete/' + row.id).then(function (response) {
                    vm.loading.app = false;
                    let resp = response.data;
